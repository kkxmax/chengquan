...
-(void)sendPostRequestWithUpload:(NSString *)actionName Parameters: (NSMutableDictionary*) params :(RequestComplitionBlock) reqBlock {
    ...
    [asyncRequest sendPostRequestWithUpload:actionName :request];
}
