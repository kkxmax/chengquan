...
#define BORDER_COLOR            [UIColor colorWithRed:254/255.0 green:188/255.0 blue:17/255.0 alpha:1.0]
...
{
//    AAPullToRefresh *view = [[AAPullToRefresh alloc] initWithImage:[UIImage imageNamed:@"pullRefresh_header"]
//                                                          position:position];
    AAPullToRefresh *view = [[AAPullToRefresh alloc] initWithImage:[[UIImage alloc] init]
                                                          position:position];
...
- (void)_commonInit
{
    self.borderColor = [UIColor colorWithWhite:1.0 alpha:0.8];//BORDER_COLOR;//[UIColor colorWithRed:147/255.0 green:149/255.0 blue:152/255.0 alpha:1.0];
    self.borderWidth = 1.2f;
