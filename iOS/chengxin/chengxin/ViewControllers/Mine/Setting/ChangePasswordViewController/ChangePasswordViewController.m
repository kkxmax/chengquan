...
-(IBAction)onCompletion:(id)sender
{
    ...
    {
        [appDelegate.window makeToast:@"旧密码不能为空"
                    duration:3.0
    ...
    {
        [appDelegate.window makeToast:@"旧密码6-20字符"
                    duration:3.0
                    position:CSToastPositionCenter
                       style:nil];
        return;
    ...
    {
        [appDelegate.window makeToast:@"新密码不能为空"
                    duration:3.0
                    position:CSToastPositionCenter
                       style:nil];
        return;
    ...
    {
        [appDelegate.window makeToast:@"新密码6-20数字和字母组成"
                    duration:3.0
                    position:CSToastPositionCenter
                       style:nil];
        return;
