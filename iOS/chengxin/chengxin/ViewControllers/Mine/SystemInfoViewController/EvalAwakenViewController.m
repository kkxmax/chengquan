...
- (void)getMyEvalFromServer {
    ...
    [dicParams setObject:@"getMyEstimateNoticeList" forKey:@"pAct"];
    ...
    [[WebAPI sharedInstance] sendPostRequest:ACTION_GETMYEVALUATELIST Parameters:dicParams :^(NSObject *resObj) {
        ...
        if (dicRes != nil ) {
            if ([dicRes[@"retCode"] intValue] == RESPONSE_SUCCESS) {
                frontEvaluateArray = (NSMutableArray *)(dicRes[@"pEstimateList"]);
                backEvaluateArray = (NSMutableArray *)(dicRes[@"nEstimateList"]);
                [CommonData sharedInstance].myEstimateCnt = frontEvaluateArray.count + backEvaluateArray.count;
...
- (void)getOtherEvalFromServer {
    NSMutableDictionary *dicParams = [[NSMutableDictionary alloc] init];
    [dicParams setObject:@"getEstimateToMeNoticeList" forKey:@"pAct"];
    [dicParams setObject:@"" forKey:@"start"];
    [dicParams setObject:@"" forKey:@"length"];
    [dicParams setObject:[CommonData sharedInstance].tokenName forKey:@"token"];
    ...
    [[WebAPI sharedInstance] sendPostRequest:ACTION_GETOTHEREVALUATELIST Parameters:dicParams :^(NSObject *resObj) {
        ...
        if (dicRes != nil ) {
            if ([dicRes[@"retCode"] intValue] == RESPONSE_SUCCESS) {
                frontEvaluateArray = (NSMutableArray *)(dicRes[@"pEstimateList"]);
                backEvaluateArray = (NSMutableArray *)(dicRes[@"nEstimateList"]);
                [CommonData sharedInstance].estimateToMeCnt = frontEvaluateArray.count + backEvaluateArray.count;
                if(frontEvaluateArray.count > 0) {
                    self.frontMarkLabel.hidden = NO;
                    self.frontMarkLabel.text = [NSString stringWithFormat:@"%d", (int)(frontEvaluateArray.count)];
                }else{
...
- (void)tableView:(UITableView *)tableView didSelectRowAtIndexPath:(NSIndexPath *)indexPath{
    ...
    NSMutableDictionary *dicParams = [[NSMutableDictionary alloc] init];
    [dicParams setObject:@"onReadEstimate" forKey:@"pAct"];
    [dicParams setObject:evalDic[@"id"] forKey:@"estimateId"];
    [dicParams setObject:[CommonData sharedInstance].tokenName forKey:@"token"];
    [[WebAPI sharedInstance] sendPostRequest:ACTION_ONREADESTIMATE Parameters:dicParams :^(NSObject *resObj) {
