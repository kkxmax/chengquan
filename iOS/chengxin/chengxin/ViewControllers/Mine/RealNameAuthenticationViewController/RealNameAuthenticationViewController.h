...
@interface RealNameAuthenticationViewController : UIViewController <ImageChooseViewControllerDelegate, BusinessSubcategoryViewControllerDelegate, UIPickerViewDelegate, UIPickerViewDataSource, UITextFieldDelegate, UITextViewDelegate>
...
@property (nonatomic, retain) IBOutlet UIImageView* enterLogoImageView;
...
@property (nonatomic, retain) IBOutlet UITextView* txtExperience;
...
@property (nonatomic, retain) IBOutlet UITextView* txtMainBusiness;
...
@property (nonatomic, retain) IBOutlet UITextView* txtCompanyComment;
@property (nonatomic, retain) IBOutlet UITextView* txtRecommend;
...
@property (nonatomic, retain) IBOutlet UIButton* btnAddEnterCertImage;
@property (nonatomic, retain) IBOutlet UIButton* btnAddCertImage;
@property (nonatomic, retain) IBOutlet UILabel* lblAddCertImage;
@property (nonatomic, retain) IBOutlet UILabel* lblAddEnterCertImage;
