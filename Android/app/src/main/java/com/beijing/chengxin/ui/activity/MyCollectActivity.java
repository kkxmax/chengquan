...
public class MyCollectActivity extends ParentFragmentActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        gridView.setHorizontalSpacing((int) getResources().getDimension(R.dimen.margin_normal));
        gridView.setVerticalSpacing((int) getResources().getDimension(R.dimen.margin_normal));
    ...
    private void getDataTask() {
        new AsyncTask<Object, Object, Object>() {
            ...
            protected Object doInBackground(Object... params) {
                FavouriteListModel comedityDatas = new SyncInfo(MyCollectActivity.this).syncMyFavouriteList(1);
                publishProgress(1, comedityDatas);

                FavouriteListModel hotDatas = new SyncInfo(MyCollectActivity.this).syncMyFavouriteList(2);
            ...
            protected void onProgressUpdate(Object... values) {
                ...
                if (result.isValid()) {
                    if(result.getRetCode() == ERROR_OK) {
                        if (index == 1) {
                            if (((FavouriteListModel) result).getList() == null || ((FavouriteListModel) result).getList().size() == 0) {
    ...
    private class ListAdapter extends BaseAdapter {
        ...
        private ArrayList<FavouriteModel> mDatas;
        private int mFlag;
