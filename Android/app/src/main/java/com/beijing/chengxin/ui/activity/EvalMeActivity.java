...
public class EvalMeActivity extends ParentFragmentActivity {
        ...
        public void onClick(View v) {
            switch (v.getId()) {
                ...
                case R.id.btn_back:
                    ...
                    break;
                case R.id.btn_write:
                    Intent intent = new Intent(EvalMeActivity.this, MakeEvaluationActivity.class);
    ...
    class EvalAsync extends AsyncTask<Object, Object, Object> {
        ...
        protected EvalListModel doInBackground(Object... strs) {
            int kind = (int) strs[0];
            EvalListModel personDatas = new SyncInfo(EvalMeActivity.this).syncEvalToMeList(1, kind);
            publishProgress(1, personDatas);

            EvalListModel enterpriseDatas = new SyncInfo(EvalMeActivity.this).syncEvalToMeList(2, kind);
