...
public class EnterpriseDetailFragment extends Fragment implements OnViewSizeChangeListener {
    ...
    private TextView txt_my_agree, txt_detail, txt_weburl, txt_main_comedity, txt_weixin, txt_boss_name, txt_boss_position, txt_boss_phone, txt_office_place, txt_recommender;
    ...
    private void showUserDetail() {
        ...
        if (accountDetail.getEnterKind() == ENTER_KIND_ENTERPRISE)
            ...
            txt_enter_type.setText(getText(R.string.enterprise_single));
        txt_name.setText(accountDetail.getEnterName());
