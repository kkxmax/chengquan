...
public class TabServeView extends BaseView {

    LinearLayout viewBodyPart, viewBlankPart;
    ListViewNoScroll listView;

    private List<ServeModel> mDatas;
    private ListAdapter mAdapter;

    public TabServeView(Context context) {
        super(context);
        initialize();
    }

    public void setData(List<ServeModel> datas) {
        this.mDatas = datas;
        initData();
    }
    ...
    protected void initUI() {
        setContentView(R.layout.view_tab_serve);
    ...
    public class ListAdapter extends BaseAdapter {
        ...
        public View getView(int position, View convertView, ViewGroup parent) {
            ...
            final ServeModel item = mDatas.get(position);
            ...
            convertView.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    ServeDetailFragment fragment = new ServeDetailFragment();
