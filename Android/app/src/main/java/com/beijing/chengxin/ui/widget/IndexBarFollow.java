...
public class IndexBarFollow extends View {
	...
	public IndexBarFollow(Context context) {
		super(context);
		init();
	}

	public IndexBarFollow(Context context, AttributeSet attrs) {
		super(context, attrs);
		init();
	}

	public IndexBarFollow(Context context, AttributeSet attrs, int defStyle) {
	...
	private void init() {
		...
		mPaint.setColor(getResources().getColor(R.color.color_gray));//Set the paint's color.
