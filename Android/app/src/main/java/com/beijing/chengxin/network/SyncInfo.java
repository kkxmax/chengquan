...
public class SyncInfo {
    ...
    public HotListModel syncHotList(){
    ...
    public BaseModel syncAddProduct(int productId, String name, String  isMain, String price, String pleixingId, String comment, String weburl, String saleAddr, List<String> productImages){
        ...
        String responseString = NetworkEngine.postMultipart(url, params, fileModelList);
    ...
    public EvalListModel syncEvalList(int akind, int kind) {
        EvalListModel result = new EvalListModel();
    ...
    // akind -> 0:all 1:person 2:enterprise
    // kind -> 0:all 1:正面评价 2:负面评价
    public EvalListModel syncEvalToMeList(int akind, int kind) {
        EvalListModel result = new EvalListModel();
    ...
    public BaseModel syncSubmitAuthEnterprise(Map<String, String> sendParams, ArrayList<Constants.UploadFileModel> fileModelList){
        BaseModel result = new BaseModel();
        ...
        String responseString = NetworkEngine.postMultipart(Constants.API_ADDR + "?pAct=authEnter&token=" + SessionInstance.getInstance().getLoginData().getToken(), sendParams, fileModelList);
    ...
    public BaseModel syncSubmitAuthPerson(Map<String, String> sendParams, ArrayList<Constants.UploadFileModel> fileModelList){
        BaseModel result = new BaseModel();

        sendParams.put(Constants.P_ACTION, "authPersonal");
        sendParams.put(Constants.P_TOKEN, SessionInstance.getInstance().getLoginData().getToken());

        String responseString = NetworkEngine.postMultipart(Constants.API_ADDR + "?pAct=authPersonal&token=" + SessionInstance.getInstance().getLoginData().getToken(), sendParams, fileModelList);
    ...
    // 诚乎记录
    public MarkLogListModel syncMarkLogList() {
    ...
    public ErrorListModel syncErrorList(int status) {
    ...
    // 我的收藏
    // kind - 1:产品 2：热点
    public FavouriteListModel syncMyFavouriteList(int kind) {
