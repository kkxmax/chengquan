...
public class IndicatorLayout extends FrameLayout implements AnimationListener {
	...
	public IndicatorLayout(Context context, PullToRefreshBase.Mode mode) {
		...
		Drawable arrowD = getResources().getDrawable(R.drawable.com_loading_small);
		mArrowImageView.setImageDrawable(arrowD);

		//final int padding = getResources().getDimensionPixelSize(R.dimen.indicator_internal_padding);
		final int padding = getResources().getDimensionPixelSize(R.dimen.margin_small);
		...
		switch (mode) {
			case PULL_FROM_END:
				inAnimResId = R.anim.slide_in_down;
				outAnimResId = R.anim.slide_out_down;
			...
			case PULL_FROM_START:
				inAnimResId = R.anim.slide_in_up;
				outAnimResId = R.anim.slide_out_up;
