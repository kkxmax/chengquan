...
public class HomeEnterpriseFragment extends Fragment {

	public final String TAG = HomeEnterpriseFragment.class.getName();
    ...
    private static HomeEnterpriseFragment instance;

    public static HomeEnterpriseFragment getInstance() {
        if (instance == null)
            instance = new HomeEnterpriseFragment();
    ...
    OnItemClickListener listItemClickListener = new OnItemClickListener() {
        ...
        UserModel user = listEnterprise.get(position);
    ...
    public class ItemDetailAdapter extends RecyclerView.Adapter<ItemDetailAdapter.ViewHolder> {
        ...
        public void onBindViewHolder(final ViewHolder viewHolder, final int position) {
            ...
            if (user.getEnterKind() == ENTER_TYPE_PERSONAL)
                viewHolder.txt_item_type.setText(getString(R.string.str_enterprise_personal));
            else
    ...
    class IncreaseViewCountAsync extends AsyncTask<String, String, BaseModel> {
        ...
        protected void onPostExecute(BaseModel result) {
            ...
            if (result .isValid()) {
                if(result.getRetCode() == ERROR_OK) {
                    UserModel user = listEnterprise.get(selectedIndex);
