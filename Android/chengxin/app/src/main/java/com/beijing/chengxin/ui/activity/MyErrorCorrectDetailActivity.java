...
public class MyErrorCorrectDetailActivity extends ParentFragmentActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        // 他方 UI Controller
        viewRivalPart = (View) findViewById(R.id.view_rival_part);
        txtItemType = (TextView) findViewById(R.id.txt_item_type);
        ...
        viewRivalPart.setOnClickListener(mButtonClickListener);
    ...
    private void initData() {
        if (mData != null) {
            ...
            txtTime.setText(CommonUtils.getDateStrFromStrFormat(mData.getWriteTimeString(), "yyyy-MM-dd HH:mm:ss", "yyyy-MM-dd HH:mm"));
            ...
            txtItemType.setText(mData.getEstimaterAkind() == Constants.ACCOUNT_TYPE_PERSON ? R.string.str_person : R.string.str_enterprise);
        ...
        public void onClick(View v) {
            switch (v.getId()) {
                case R.id.btn_back:
                    onBackPressed();
                    break;
                case R.id.view_rival_part:
                    mData.getEstimaterId();
                    Intent intent = new Intent(mContext, DetailActivity.class);
                    intent.putExtra("id", mData.getEstimaterId());
                    intent.putExtra("type", Constants.INDEX_ENTERPRISE);
                    intent.putExtra("akind", mData.getEstimaterAkind());
