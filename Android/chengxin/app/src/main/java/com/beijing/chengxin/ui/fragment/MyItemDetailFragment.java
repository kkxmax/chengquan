...
public class MyItemDetailFragment extends Fragment {
    ...
    public void setData(MyWriteFragment writeFragment, ItemModel item) {
                    ...
                    alertDialogBuilder
                            ...
                            .setPositiveButton(R.string.ok, new DialogInterface.OnClickListener() {
                                ...
                                public void onClick(DialogInterface dialog, int which) {
                                    mWriteFragment.actionDeleteTask(2, item.getId(), new OnCallbackListener() {
                                        @Override
                ...
                case R.id.btn_action2: {
                    ...
                    alertDialogBuilder
                            ...
                            .setPositiveButton(R.string.ok, new DialogInterface.OnClickListener() {
                                @Override
                                public void onClick(DialogInterface dialog, int which) {
                                    mWriteFragment.actionUpDownTask(2, actionIndex, item.getId(), new OnCallbackListener() {
                                        @Override
                                        public void onCallback() {
