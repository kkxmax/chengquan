...
public class ServeDetailFragment extends Fragment {
	...
	public final String TAG = ServeDetailFragment.class.getName();
    ...
    private TextView txt_name, txt_leixing, txt_city, txt_code, txt_comment, txt_weburl, txt_addr, txt_relation_name, txt_relation_mobile, txt_relation_weixin, txt_enter_name, txt_enter_code, txt_enter_rate, txt_write_time, txt_enter_type;

    SyncInfo info;
    ServeModel item;

    public void setItem(ServeModel item) {
        this.item = item;
    }
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
    	rootView = inflater.inflate(R.layout.fragment_serve_detail, container, false);
    ...
    public void showShare(Context context, String platformToShare, boolean showContentEdit) {
        ...
        final String title = "【服务】您的好友给您分享了一项服务，立即查看！";

        final String url = Constants.SERVE_SHARE_URL + item.getId();
        ...
        oks.setCallback(new PlatformActionListener() {
            ...
            public void onComplete(Platform platform, int i, HashMap<String, Object> hashMap) {
                ...
                HttpApi.onShare(Constants.SHARE_KIND.SERVICE, item.getId());
            }
