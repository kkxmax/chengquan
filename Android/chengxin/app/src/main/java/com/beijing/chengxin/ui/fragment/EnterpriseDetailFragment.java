...
public class EnterpriseDetailFragment extends Fragment implements OnViewSizeChangeListener {
    ...
    public final String TAG = EnterpriseDetailFragment.class.getName();
    ...
    private Button btnArrowUp, btnMakeEval;
    private ImageView img_avatar, img_business_cert;
    private TextView txt_enter_type, txt_name, txt_leixing, txt_chengxin_id, txt_chengxin_rate, txt_like_count, txt_eval_count;
    private TextView txt_my_agree, txt_detail, txt_weburl, txt_main_comedity, txt_weixin, txt_boss_name, txt_boss_position, txt_boss_phone, txt_boss_weixin, txt_office_place, txt_recommender;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        rootView = inflater.inflate(R.layout.fragment_enterprise_detail, container, false);

        // set title
        ((TextView)rootView.findViewById(R.id.txt_nav_title)).setText(getString(R.string.enterprise_detail));
        ...
        btnArrowUp = (Button) rootView.findViewById(R.id.btn_arrow_up);
        ...
        img_business_cert = (ImageView)rootView.findViewById(R.id.img_business_cert);
        ...
        txt_my_agree = (TextView)rootView.findViewById(R.id.txt_my_agree);
        txt_detail = (TextView)rootView.findViewById(R.id.txt_detail);
        ...
        txt_boss_name = (TextView)rootView.findViewById(R.id.txt_boss_name);
        txt_boss_position = (TextView)rootView.findViewById(R.id.txt_boss_position);
        txt_boss_phone = (TextView)rootView.findViewById(R.id.txt_boss_phone);
        txt_boss_weixin = (TextView)rootView.findViewById(R.id.txt_boss_weixin);
        txt_office_place = (TextView)rootView.findViewById(R.id.txt_office_place);
        ...
        scrollView = (LinearLayout)rootView.findViewById(R.id.display_scrollview);
    ...
    public void showShare(Context context, String platformToShare, boolean showContentEdit) {
        ...
        final String title = "【企业详情】您的好友给您分享了一份企业详情，立即查看！";

        final String url = String.format(Constants.ENTERPRISE_SHARE_URL, accountDetail.getId(), SessionInstance.getInstance().getLoginData().getUser().getId());
        ...
        if (accountDetail != null) {
            descStr += accountDetail.getEnterName();
            descStr += ", 诚信度" + accountDetail.getCredit() + "%";
            descStr += ", " + accountDetail.getMainJob();
            descStr += ", " + accountDetail.getRecommend();
        }
        ...
        oks.setCallback(new PlatformActionListener() {
            ...
            public void onComplete(Platform platform, int i, HashMap<String, Object> hashMap) {
                ...
                HttpApi.onShare(Constants.SHARE_KIND.ENTERPRISE_DETAIL, accountDetail.getId());
            }
    ...
    View.OnClickListener mClickListener = new View.OnClickListener() {
        ...
        public void onClick(View v) {
            switch (v.getId()){
                case R.id.btn_share:
//                    Toast.makeText(getContext(), "enterprise shared click", Toast.LENGTH_SHORT).show();
    ...
    private void showUserDetail() {
        if (accountDetail == null)
            return;
        /*if (accountDetail.getEnterKind() == ENTER_KIND_ENTERPRISE)
            txt_enter_type.setText(getText(R.string.str_enterprise_gongsi));
        else
            txt_enter_type.setText(getText(R.string.str_enterprise_personal));*/
        txt_enter_type.setText(getText(R.string.enterprise));
        ...
        txt_my_agree.setText(accountDetail.getRecommend());
        txt_detail.setText(accountDetail.getComment());
        txt_weburl.setText(accountDetail.getWeburl());
        txt_main_comedity.setText(accountDetail.getMainJob());
        txt_weixin.setText(accountDetail.getWeixin());
        txt_boss_name.setText(accountDetail.getBossName());
        txt_boss_position.setText(accountDetail.getBossJob());
        txt_boss_phone.setText(accountDetail.getBossMobile());
        txt_boss_weixin.setText(accountDetail.getBossWeixin());
        txt_office_place.setText(accountDetail.getCityName() + " " + accountDetail.getAddr());
