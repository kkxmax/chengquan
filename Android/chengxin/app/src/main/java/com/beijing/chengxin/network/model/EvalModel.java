...
public class EvalModel  {
    ...
    String ownerLogo;
    String reason;
    List<EvalModel> replys;
    int serial;
    int targetAccountAkind;
    int targetAccountElectCnt;
    String targetAccountEnterName;
    int targetAccountFeedbackCnt;
    String targetAccountLogo;
    String targetAccountMobile;
    String targetAccountRealname;
    int type;
    String updateTime;
    int upperId;
    ...
    public List<EvalModel> getReplys() {
        return replys;
    }

    public void setReplys(List<EvalModel> replys) {
        this.replys = replys;
    }
