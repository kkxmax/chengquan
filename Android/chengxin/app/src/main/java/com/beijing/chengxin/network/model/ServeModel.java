...
public class ServeModel implements Parcelable {
    int id;
    String code;
    int fenleiId;
    String fenleiName;
    ...
    public static final Parcelable.Creator<ServeModel> CREATOR = new Parcelable.Creator<ServeModel>() {
        @Override
        public ServeModel createFromParcel(Parcel in) {
            return new ServeModel(in);
        }

        @Override
        public ServeModel[] newArray(int size) {
            return new ServeModel[size];
        }
    };
