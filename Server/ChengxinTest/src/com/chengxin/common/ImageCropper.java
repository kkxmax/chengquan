...
public class ImageCropper {
	public static String ImageCrop(String absoluteDir, String fileName, double sw, double sh, double x, double y, double w, double h) {
		try {
			...
			File file = new File(absoluteDir + Constants.C_COMMON_FILE_PATH_SEP + fileName);
			...
			File outputfile = new File(absoluteDir + Constants.C_COMMON_FILE_PATH_SEP + tmpFileName + "." + extension);
