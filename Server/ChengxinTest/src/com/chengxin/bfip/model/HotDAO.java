...
public class HotDAO extends BaseDataAccessObject {
    ...
    public Hot getDetail(HttpServletRequest request, int id) throws IOException {
        ...
        List<Hot> resultList = this.search(request, filterParamObject);
    ...
    public List<Hot> search(HttpServletRequest request, JSONObject filterParamObject) throws IOException {
    	return search(request, filterParamObject, "");
    }
    
    public List<Hot> search(HttpServletRequest request, JSONObject filterParamObject, String extraWhere) throws IOException {
    	return search(request, filterParamObject, extraWhere, "");
    }
    
    public List<Hot> search(HttpServletRequest request, JSONObject filterParamObject, String extraWhere, String extraOrder) throws IOException {
    	return search(request, filterParamObject, extraWhere, extraOrder, "");
    }
    
    public List<Hot> search(HttpServletRequest request, JSONObject filterParamObject, String extraWhere, String extraOrder, String groupby) throws IOException {
        ...
        if (queryList != null) {
            ...
            for(int i = 0; i < listSize; i++) {
                ...
                row.setContentString(CommonUtil.readFile(CommonUtil.getRepositoryRealPath(request) + Constants.C_COMMON_FILE_PATH_SEP + ".." + CommonUtil.toStringDefault(objectArray[9]).replace("/", Constants.C_COMMON_FILE_PATH_SEP)));
                ...
                row.setSummary(CommonUtil.toStringDefault(objectArray[31]));
