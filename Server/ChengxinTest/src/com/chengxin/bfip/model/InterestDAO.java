 ...
 */
public class InterestDAO extends BaseDataAccessObject {

    private static String VIEW = "interests_v";
    
    
    public void insert(Interest interest) {
        DBModelUtil.processSecure(Interest.class.getName(), interest, DBModelUtil.C_SECURE_TYPE_ENCRYPT);
    ...
    public void update(Interest interest) {
        ...
        this.getHibernateTemplate().update(interest);
    }
    
    public void delete(Interest interest) {
        DBModelUtil.processSecure(Interest.class.getName(), interest, DBModelUtil.C_SECURE_TYPE_ENCRYPT);
        
        this.getHibernateTemplate().delete(interest);
    }
    
    public Interest getDetail(String where) {
        
        List<Interest> resultList = this.search(null, where);
    ...
    private SQLWithParameters _makeSearchQuery(boolean isCountSQL, JSONObject filterParamObject, String extraWhere, String extraOrder) {
        ...
        if(isCountSQL) {
            ...
            sql.appendSQL("SELECT id, target, owner, write_time ");
        }
    ...
    public List<Interest> search(JSONObject filterParamObject) {
    	return search(filterParamObject, "");
    }
    
    public List<Interest> search(JSONObject filterParamObject, String extraWhere) {
    	return search(filterParamObject, extraWhere, "");
    }
    
    public List<Interest> search(JSONObject filterParamObject, String extraWhere, String extraOrder) {
