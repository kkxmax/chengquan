			...
			<form action="${cur_page}?pAct=upload" id="_frm" class="form-horizontal" method="post" accept-charset="utf-8" enctype="multipart/form-data">
				<div class="form-body">
					...
					<div class="form-group">
						...
						<div class="col-md-7">
							<img src="/ChengxinTest/Upload/image/carousel/bg.png" id="img" class="img-responsive" />
						...
						<div class="col-md-3">
							<div id="preview-pane">
								<div class="preview-container" style="width: 175px; height: 58px">
									<img src="/ChengxinTest/Upload/image/carousel/bg.png" class="jcrop-preview" />
			...
			if ((typeof file.type !== "undefined" ? file.type.match(/^image\/(png|jpeg)$/) : file.name.match(/\.(png|jpe?g)$/i)) && typeof FileReader !== "undefined") {
				...
				reader.onload = function(re) {
					...
					img_file.onload = function() {
						...
						$('#img').css('height', img_file.height * width / img_file.width + 'px');
...
/* 				if ($('#crop_x').val() == undefined || $('#crop_y').val() == undefined || $('#crop_w').val() == 0 || $('#crop_h').val() == 0) {
					toastr['error']('选择图片。');
					return false;
				} */
