	...
	function chart(data) {
		var chart = AmCharts.makeChart("chart_2", {
			...
			"graphs" : [ {
				...
				"title" : "个人详情",
				"fillAlphas" : 0,
				"valueField" : "personal_detail_cnt",
				"valueAxis" : "personalAxis"
			}, {
				"balloonText" : "企业:[[value]]",
				"bullet" : "round",
				"bulletBorderAlpha" : 1,
				"useLineColorForBulletBorder" : true,
				"bulletColor" : "#FFFFFF",
				...
				"title" : "企业详情",
				"fillAlphas" : 0,
				"valueField" : "enterprise_detail_cnt",
				"valueAxis" : "personalAxis"
			} , {
				"balloonText" : "诚信报告:[[value]]",
				"bullet" : "round",
				"bulletBorderAlpha" : 1,
				"useLineColorForBulletBorder" : true,
				"bulletColor" : "#FFFFFF",
				...
				"title" : "诚信报告",
				"fillAlphas" : 0,
				"valueField" : "report_cnt",
				"valueAxis" : "personalAxis"
			}, {
				"balloonText" : "热点详情:[[value]]",
				"bullet" : "round",
				"bulletBorderAlpha" : 1,
				"useLineColorForBulletBorder" : true,
				"bulletColor" : "#FFFFFF",
