      ...
      <form id="test-form" class="form-horizontal" method="post" action="${cur_page}?pAct=changeTestStatus">
        ...
        <div class="form-body col-xs-12">
          ...
          <div class="form-group">
            ...
            <label class="col-xs-8 align-left">${record.xyName}</label>
          </div>
          <div class="form-group">
            <label class="col-xs-4 align-right">所在地:</label>
            <label class="col-xs-8 align-left">${record.provinceName} ${record.cityName} ${record.addr}</label>
          </div>
          <div class="form-group">
            <label class="col-xs-4 align-right">职位:</label>
            <label class="col-xs-8 align-left">${record.job}</label>
          </div>
          <div class="form-group">
            <label class="col-xs-4 align-right">工作经验:</label>
            <label class="col-xs-8 align-left">${record.experience}</label>
          </div>
          <div class="form-group">
            <label class="col-xs-4 align-right">个人经历:</label>
            <label class="col-xs-8 align-left">${record.history}</label>
          </div>
          <div class="form-group">
            <label class="col-xs-4 align-right">特长或喜欢的行业:</label>
            <label class="col-xs-8 align-left">${record.xyWatchedName}</label>
          </div>
          <div class="form-group">
            <label class="col-xs-4 align-right">喜欢的资源或朋友:</label>
            <label class="col-xs-8 align-left">${record.xyWatchName}</label>
          </div>
        </div>
      </form>
    </div>
