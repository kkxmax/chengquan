      ...
      <div class="form-horizontal">
        <div class="form-body col-xs-12">
          <div class="form-group">
			...
			<div class="form-group">
				<label class="col-xs-2 text-right">简介:</label> <label
					class="col-xs-10 text-left">${record.summary}</label>
			</div>
			<div class="form-group">
				<label class="col-xs-2 text-right">文章正文:</label> <label
					class="col-xs-10 text-left">${record.contentString}</label>
			</div>
			<div class="form-group">
