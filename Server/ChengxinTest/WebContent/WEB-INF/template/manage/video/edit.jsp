					...
					<div class="form-group">
						...
						<div class="col-md-4">
							<div>
								...
								<span id="video_file_info" class="fileinput-filename">${record.videoName}</span>
								<a href="javascript:del_video();" class="close fileinput-exists" data-dismiss="fileinput"></a>
							</div>
						</div>
					</div>
<!-- 					<div class="form-group"> -->
...
<!-- 					</div> -->
					<div class="form-group">
						...
						<div class="col-md-4">
							<textarea id="comment" name="comment" rows="5" class="form-control">${record.comment}</textarea>
						</div>
					</div>
				</div>
...
<script>
	...
	jQuery(document).ready(function() {
		...
		form.ajaxForm({
			beforeSubmit: function(formData, $form, options) {
				...
				if(g_video_deleted && !g_video_file) {
	...
	function del_video() {
		$('#video_file_info').empty();
		g_video_deleted = true;
	}
</script>
