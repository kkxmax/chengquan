...
<div class="row init-div">
	...
	<div class="navbar navbar-fixed-top">
		...
		<div class="row init-div blue-gradient"
			style="padding: 10px 10px 10px 10px; margin-top: -1px">
			<div class="col-xs-12 init-div-horizontal"
				style="margin-bottom: 10px;">
				<div style="width: 50px; height: 50px; position: relative;">
					<div>
						<img id="img_logo" alt="" src="assets/custom/img/no_image.png"
							style="width: 50px; height: 50px;" />
					</div>
					<div class=" orange-gradient text-center"
						style="margin-top: -17px; width: 50px; height: 17px; position: absolute;">
						<span id="txt_akind" class="text-white font-xs"></span>
					</div>
				</div>
				<div style="float: left; margin-left: 58px; margin-top: -45px">
					<div class="row init-div">
						<div
							style="max-width: 100%; height: 22px; overflow: hidden; float: left;">
							<span id="txt_name" class="text-white font-lg"></span>
						</div>
						<div style="float: left; margin-top: 5px">
							<span id="txt_leixing" class="text-white font-sm"
								style="border: solid 1px white; border-radius: 4px !important; padding: 1px 4px 1px 4px;">
								</span>
						</div>
					</div>
					<div class="row init-div">
						<span class="text-white font-sm">诚信代码：<span id="txt_code"></span></span>
					</div>
				</div>
			</div>
			...
			<div class="col-xs-12 init-div-horizontal" style="margin-top: 7px">
				<div class="col-xs-4 init-div-horizontal">
					<div class="col-xs-6 init-div-horizontal text-right">
						<span class="text-white font-xs">诚信度：</span>
					</div>
					<div class="col-xs-6 init-div-horizontal text-left">
						<span id="txt_percent" class="text-white font-xs"></span>
					</div>
				</div>
				<div class="col-xs-4 init-div-horizontal">
					<div class="col-xs-6 init-div-horizontal text-right">
					...
					<div class="col-xs-6 init-div-horizontal text-left">
						<span id="txt_help_dot" class="text-white font-xs"></span>
					</div>
				</div>
				<div class="col-xs-4 init-div-horizontal">
					<div class="col-xs-6 init-div-horizontal text-right">
					...
					<div class="col-xs-6 init-div-horizontal text-left">
						<span id="txt_eval" class="text-white font-xs"></span>
					</div>
				</div>
			</div>
		</div>
	...
	<div class="col-xs-12 init-div-horizontal"
		style="margin-top: 154px; padding-bottom: 60px;">

		<div class="row init-div">
			<div class="col-xs-12 horizontal-divider-8"></div>
			<div
				class="col-xs-12  init-div-horizontal margin-bottom-10 margin-top-10">
				<div class="blue-prefix"></div>
				<span class="text-gray font-md">我们承诺</span>
			</div>
			<div class="col-xs-12 horizontal-divider"></div>
			<div class="col-xs-12 margin-bottom-10 margin-top-10">
				<span id="txt_recommend" class="text-dark font-md"></span>
			</div>
			...
			<div
				class="col-xs-12  init-div-horizontal margin-bottom-10 margin-top-10">
				<div class="blue-prefix"></div>
				<span class="text-gray font-md">公司信息</span>
			</div>
			<div class="col-xs-12 horizontal-divider"></div>
			<div class="col-xs-12 margin-bottom-10 margin-top-10">
				<span id="txt_comment" class="text-dark font-md"></span>
			</div>
				...
				<div id="slide_content">
					<div class="row init-div margin-bottom-10 margin-top-10">
						<div class="col-xs-10 init-div-horizontal">
							<span class="text-gray-light font-sm">公司官网：<a
					...
					<div class="row init-div margin-bottom-10 margin-top-10">
						<span class="text-gray-light font-sm">主营业务：</span><span
							id="txt_mainjob" class="text-dark font-md"></span>
					</div>
					<div class="row init-div horizontal-divider"></div>
					<div class="row init-div margin-bottom-10 margin-top-10">
						<span class="text-gray-light font-sm">微信公众号：</span><span
							id="txt_weixin" class="text-dark font-md"></span>
					</div>
					<div class="row init-div horizontal-divider"></div>
					<div class="row init-div margin-bottom-10 margin-top-10">
						<span class="text-gray-light font-sm">负责人姓名：</span><span
							id="txt_boss_name" class="text-dark font-md"></span>
					</div>
					<div class="row init-div horizontal-divider"></div>
					<div class="row init-div margin-bottom-10 margin-top-10">
						<span class="text-gray-light font-sm">负责人职位：</span><span
							id="txt_boss_pos" class="text-dark font-md"></span>
					</div>
					<div class="row init-div horizontal-divider"></div>
					<div class="row init-div margin-bottom-10 margin-top-10">
						<span class="text-gray-light font-sm">负责人手机号：</span><span
							id="txt_boss_mobile" class="text-dark font-md"></span>
					</div>
					<div class="row init-div horizontal-divider"></div>
					<div class="row init-div margin-bottom-10 margin-top-10">
						<span class="text-gray-light font-sm">负责人微信号：</span><span
							id="txt_boss_weixin" class="text-dark font-md"></span>
					</div>
					<div class="row init-div horizontal-divider"></div>
					<div class="row init-div margin-bottom-10 margin-top-10">
						<span class="text-gray-light font-sm">办公地址：</span><span
							id="txt_city" class="text-dark font-md"></span>
					</div>
					<div class="row init-div horizontal-divider"></div>
					<div class="row init-div margin-bottom-10 margin-top-10">
						<div class="col-xs-10 init-div-horizontal">
					...
					<div class="row init-div horizontal-divider"></div>
					<div class="row init-div margin-bottom-10 margin-top-10">
						<span class="text-gray-light font-sm" style="position: absolute">办公地址：</span>
						<img id="img_cert_photo" alt=""
							src="assets/custom/img/no_image.png"
							style="width: 80px; height: 80px; margin-left: 130px;" />
					</div>

					<div class="row init-div horizontal-divider"></div>
				</div>
				<div class="row init-div margin-bottom-10 margin-top-10 text-center">
					<img id="img_arrow_up" alt="" src="assets/custom/img/arrow_up.png"
						style="width: 10px" /> <span class="text-gray-light font-sm"
						id="arrow_up">收起</span>
				</div>
			</div>
			...
			<div class="col-xs-12  init-div-horizontal">
				<ul class="nav nav-tabs nav-tabs-sm" style="margin-bottom: 0;">
					<li class="active" style="width: 25%;"><a href="#tab_01"
						data-toggle="tab" class="text-center"> 评价 </a></li>
					<li style="width: 25%;"><a href="#tab_02" data-toggle="tab"
						class="text-center"> 产品 </a></li>
					<li style="width: 25%;"><a href="#tab_03" data-toggle="tab"
						class="text-center"> 项目 </a></li>
					<li style="width: 25%;"><a href="#tab_04" data-toggle="tab"
						class="text-center"> 服务 </a></li>
				</ul>
					...
					<div class="tab-pane fade active in" id="tab_01">
						<div class="row init-div"
							...
							<div class="col-xs-4 init-div-horizontal text-center">
								<button id="quanbu" clicked="1" style="width: 90%;" class="orange-gradient btn-eval text-white">全部</button>
							</div>
							<div class="col-xs-4 init-div-horizontal text-center">
						...
						<div class="row init-div" id="item_pingjia"></div>
					</div>

					<div class="tab-pane fade" id="tab_02" style="background: #f5f5f5;"></div>

					<div class="tab-pane fade" id="tab_03"></div>

					<div class="tab-pane fade" id="tab_04"></div>
	...
	<div class="front-page-footer">
		<div class="row init-div">
			<div class="col-xs-7">
				<img src="assets/custom/img/login_logo.png"
					style="width: 50px; float: left">
				<div style="padding-left: 56px; padding-top: 6px">
					<p
						style="font-size: 18px; font-weight: bold; color: #1793e5; margin-bottom: 0">诚乎</p>
					<p style="color: #1793e5">你的话语权主场</p>
				</div>
			</div>
			<div class="col-xs-5" style="padding-top: 8px">
				<div
					style="border: solid 1px #368fe7; border-radius: 4px !important; padding: 4px; text-align: center;">
					<a href="#" id="btn_send_verifycode"
						style="color: #368fe7; text-decoration: none; font-size: 14px">下载客户端</a>
				</div>
			</div>
		</div>
	</div>
	...
	<!-- <div class="float-action-button">
		<img style="width: 100%; height: 100%;"
			src="assets/custom/img/call.png" />
	</div> -->
	<!-- END CONTENT -->
		...
		success : function(res) {
			...
			if (res.retCode == 200) {
				...
				if(account.akind == 1){
					...
					if(account.enterKind == 2){
						akind = "个体户";
					}else{
						akind = "企业";
					}
				}
				$('#txt_akind').html(akind);
				...
				$('#txt_name').html(account.enterName);
				$('#txt_code').html(account.code);
				$('#txt_percent').html(account.credit+"%");
				$('#txt_help_dot').html(account.electCnt);
				$('#txt_eval').html(account.feedbackCnt);
