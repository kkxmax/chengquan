...
<%@ include file="/WEB-INF/template/front/layout/body_top.jsp"%>
            ...
            <div class="col-xs-12 init-div-horizontal" style="margin-top: 150px; padding-bottom:60px;">
                ...
                <div class="row init-div">
                    ...
                    <div class="col-xs-12">
                        <div class="row init-div margin-bottom-10 margin-top-10">
                            <div class="col-xs-10 init-div-horizontal">
                                <span class="text-gray-light font-sm">公司网址：<a id="txt_weburl" class="text-blue" style="margin-left: 10px;" href="#"></a></span>
                            </div>
                        ...
                        <div class="row init-div margin-bottom-10 margin-top-10">
                            <span class="text-gray-light font-sm">主营业务：</span><span id="txt_mainjob" class="text-dark font-md"></span>
                        </div>
                        <div class="row init-div horizontal-divider"></div>
                        <div class="row init-div margin-bottom-10 margin-top-10">
                            <span class="text-gray-light font-sm">微信公众号：</span><span id="txt_weixin" class="text-dark font-md"></span>
                        </div>
                        <div class="row init-div horizontal-divider"></div>
                        <div class="row init-div margin-bottom-10 margin-top-10">
                            <span class="text-gray-light font-sm">负责人姓名：</span><span id="txt_boss_name" class="text-dark font-md"></span>
                        </div>
                        <div class="row init-div horizontal-divider"></div>
                        <div class="row init-div margin-bottom-10 margin-top-10">
                            <span class="text-gray-light font-sm">负责人职位：</span><span id="txt_boss_pos" class="text-dark font-md"></span>
                        </div>
                        <div class="row init-div horizontal-divider"></div>
                        <div class="row init-div margin-bottom-10 margin-top-10">
                            <span class="text-gray-light font-sm">负责人手机号：</span><span id="txt_boss_mobile" class="text-dark font-md"></span>
                        </div>
                        <div class="row init-div horizontal-divider"></div>
                        <div class="row init-div margin-bottom-10 margin-top-10">
                            <span class="text-gray-light font-sm">负责人微信号：</span><span id="txt_boss_weixin" class="text-dark font-md"></span>
                        </div>
                        <div class="row init-div horizontal-divider"></div>
                        <div class="row init-div margin-bottom-10 margin-top-10">
                            <span class="text-gray-light font-sm">办公地址：</span><span id="txt_city" class="text-dark font-md"></span>
                        </div>
                    </div>
                    ...
                    <div class="col-xs-12 init-div-horizontal margin-bottom-10 margin-top-10">
                        <div class="blue-prefix"></div>
                         <span class="text-gray font-md">营业执照照片</span>
                    </div>
                    <div class="col-xs-12 horizontal-divider"></div>
                    <div class="col-xs-12 margin-bottom-10 margin-top-10">
                        <img id="img_cert_photo" alt="" src="assets/custom/img/cert_enter.png" style="width: 100%;" />
                    </div>
                    ...
                    <div class="row init-div" id="recommender_part" style="display: none;">
	                    ...
	                    <div class="col-xs-12">
	                        <div class="margin-bottom-10 margin-top-10">
	                            ...
	                            <div style="float:left; margin-left: 10px;">
	                                <div class="row init-div">
	                                    <span id="txt_enter_name" class="text-dark font-md"></span>
	                                    <span id="txt_enter_leixing" class="text-blue font-sm"  style="border: solid 1px #1793E5; border-radius: 4px !important; padding: 1px 4px 1px 4px;margin-left: 4px;"></span>
	                                </div>
            ...
            <!-- <div class="float-action-button">
                <img style="width:100%; height:100%;" src="assets/custom/img/call.png" onclick="make_call()"/>
            </div> -->
            <!-- END CONTENT -->
            ...
            $.ajax({
                ...
                success: function(res) {
                    ...
                    if (res.retCode == 200) {
                    	...
                    	var img_cert_img = (account.enterCertImage)?uploadPath+account.enterCertImage:"assets/custom/img/no_image.png";
                    	$('#img_cert_photo').attr('src' , img_cert_img);
                ...
                success: function(res) {
                    ...
                    if (res.retCode == 200) {
                    	if (res.inviterInfo) {
	                    	...
	                    	$('#txt_enter_name').html(inviterName.length == 0 ? inviterInfo.mobile : inviterName);
